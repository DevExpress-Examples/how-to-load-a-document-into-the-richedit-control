...
Namespace LoadDocument
    ...
    Public Partial Class Form1
        ...
        Private Shared Function GetResourceStream(ByVal resourceName As String) As Stream
            Return Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream(resourceName)
        End Function
        ...
        Private Sub btnLoadString_Click(ByVal sender As Object, ByVal e As EventArgs)
