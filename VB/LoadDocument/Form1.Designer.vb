...
'			Me.btnLoadString.Click += New System.EventHandler(Me.btnLoadString_Click);
			' 
			' btnLoadStream
			' 
...
'			Me.btnLoadStream.Click += New System.EventHandler(Me.btnLoadStream_Click);
			' 
			' btnLoadFile
			' 
...
'			Me.btnLoadFile.Click += New System.EventHandler(Me.btnLoadFile_Click);
		...
		Private WithEvents btnLoadStream As DevExpress.XtraEditors.SimpleButton
		Private WithEvents btnLoadString As DevExpress.XtraEditors.SimpleButton
	End Class
End Namespace
